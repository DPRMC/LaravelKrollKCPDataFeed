...
class KrollLoanGroup extends Model {
    ...
    protected $casts = [
        ...
        self::percent_of_pool => 'float',
        self::probability_of_default => 'float',
        self::projected_time_to_default_months => 'float',
        self::estimated_time_to_resolution_months => 'float',
        self::klgd => 'float',
        self::concluded_kcp_modeled_loss => 'float',
        self::conservative_kcp_modeled_loss => 'float',
        self::optimistic_kcp_modeled_loss => 'float',
        self::additional_debt_senior_to_trust => 'float',
        self::additional_debt_sub_secured => 'float',
        self::additional_debt_sub_mezz => 'float',
        self::additional_debt_sub_unsecured => 'float',
